 ...
 ?>
  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
    ...
    <tr>
     ...
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">Jumlah Potong</th>
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">Jenis Cucian</th> 
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">Berat Kg</th> 
...
<tbody>
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900' >".$kodecucian = $user_data['kodecucian']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$jumlahpotong =$user_data['jumlahpotong']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$jeniscucian = $user_data['jeniscucian']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$berat = $user_data['berat_kg']."</td>";
	    	echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$harga = $user_data['harga']."</td>"; 
        echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'><a  href='edit.php?kodecucian=$user_data[kodecucian]'>Edit</a> | <a href='delete.php?kodecucian=$user_data[kodecucian]'>Delete</a></td></tr>";        
    }
    ?>
</tbody>
    </table>
