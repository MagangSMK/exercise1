...
<div class="flex flex-col">
  <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
    ...
    <tr>
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">kode Transaksi</th> 
     ...
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">Kode Cucian</th> 
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">tanggal Masuk</th> 
     <th scope="col" class="text-sm font-medium text-white px-1 py-2">Tanggal Keluar</th> 
    ...
    while($user_data3 = mysqli_fetch_array($result3)) {         
        ...
        echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$kodetransaksi = $user_data3['kodetransaksi']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$kodekaryawan =$user_data3['kodekaryawan']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$kodepelanggan = $user_data3['kodepelanggan']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$kodecucian = $user_data3['kodecucian']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tanggalmasuk = $user_data3['tanggalmasuk']."</td>";
		    echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$tanggalkeluar = $user_data3['tanggalkeluar']."</td>";
        echo "<td class='px-1 py-1 whitespace-nowrap text-sm font-medium text-gray-900'>".$jumlah1 = $user_data3['jumlah']."</td>"; 
